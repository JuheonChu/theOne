...
$(function() {
	$("#selectBox").change(function() {
		var num = $(this).val();
		if(num==("매출현황")){
		location.href="http://192.168.6.118:8080/product/hanshin/resources/saleschart.do?franchisekey=<%=request.getParameter("franchisekey")%>"
		}
		});
});
</script>
...
List<SurveyVO> list1 = (List<SurveyVO>)request.getAttribute("hanshinaverage"); 
...
var myChart = new Chart(ctx, {
    ...
    options: {
		...
		<select id="selectBox" style="    right: 0;
    float: right;
    position: relative;
    top: 130px;">
