...
<%
	...
	String detailAddr = "";
	if(member.getDetailaddress()==null){
		detailAddr  = "";
	}else{
		detailAddr = member.getDetailaddress();
	}
%>
					...
					<tr>
						<td>
																	...
																	<tr>
																		<td width="150"
																			...
																			<div class="bak_item">
																				...
																				<img
																					src="${pageContext.request.contextPath}/resources/images/hanshin/<%=list.get(i).getImage() %>"
																					width="150" height="150">
																			</div>
																		</td>
																		<td width="150"
																			style="border-bottom: 4px solid orange;"><%=list.get(i).getMenu()%></td>
																		<td width="150"
							...
							<table width="796" border="0" cellspacing="0" cellpadding="0"
								...
								<tr>
									<td height="20" align="left">
									<input type="text" name="name" size="40" value="<%=detailAddr%>"
							...
							<table width="796" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td align="center">
										...
										<a href="${pageContext.request.contextPath}/product/hanshin/buyAction?
										id=<%=member.getId() %>&iuid=<%=franchisekey %>" class="btn btn-primary" 
