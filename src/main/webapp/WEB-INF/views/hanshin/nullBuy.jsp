			...
			<td align="center">
				<table width="1000" border="0" cellspacing="0" cellpadding="0">
					<tr>
																	...
																	<tr>
																		<td width="150"
																			...
																			<div class="bak_item">
																				...
																				<img
																					src="${pageContext.request.contextPath}/resources/images/hanshin/<%=product.getImage() %>"
						...
						<form action="${pageContext.request.contextPath}/product/hanshin/nullBuyAction?pid=<%=product.getIdx() %>&sum=<%=sum %>&count=<%=count %>&franchisekey=<%=franchisekey %>" method="post">
							<table width="796" border="0" cellspacing="0" cellpadding="0">
								<tr>
								...
								<tr>
									...
									<input type="text" name="address" size="40" placeholder="주소" required = ""/></td>
								</tr>

								<tr>
									<td height="20" align="left">
									<input type="text" name="detailaddress" size="40" value="" placeholder="상세 주소"/></td>
								</tr>

								<tr>
									<td align="left">핸드폰번호</td>
									<td align="left">
										<input type="text" name="phone" size="15"  placeholder="핸드폰 번호" required = ""/></td>
								</tr>
