...
function whereami(elt) {
    ...
    function success(pos) {
		...
		var myCurPos = "내 현재위치";
		var iwContent = '<div style="padding:18px;background-color:red;">' + myCurPos + '<br><a href="https://map.kakao.com/link/map/' +	myCurPos + ',' + latitude+ ',' + longitude+ '" style="color:blue;background-color:yellow;" target="_blank">큰지도보기</a> <a href="https://map.kakao.com/link/to/' +	myCurPos + ',' + latitude+ ',' + longitude+ '" style="color:blue;background-color:yellow;" target="_blank">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
  ...
  //     document.getElementById("userlatitude").value = pos.coords.latitude;
  //      document.getElementById("userlongitude").value = pos.coords.longitude;
    }    
}