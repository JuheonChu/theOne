...
//state: 애플리케이션이 생성한 상태 토큰
	private final static String CLIENT_ID = "DhyhFb5WDyOU60wyNLO_";
	private final static String CLIENT_SECRET = "jcJnVX9rUA";
	private final static String REDIRECT_URI = "http://192.168.6.118:8080/member/naverLogin";
